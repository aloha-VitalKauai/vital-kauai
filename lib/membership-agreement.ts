// Vital Kauaʻi Church Membership Agreement. Server-safe data module so
// both the portal modal at /portal and the founder printable view at
// /dashboard/sops/membership-agreement can share the same source.

export const MEMBERSHIP_AGREEMENT = {
  subtitle: "A Private Church Association",
  heading: "Membership Application",
  preamble:
    "By becoming a member of Vital Kauai, I agree to the following terms and conditions:",
  terms: [
