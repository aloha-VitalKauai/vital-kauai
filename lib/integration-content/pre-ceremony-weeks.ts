...
export const WEEKS = [
  ...
  },
  {
    ...
    video: { label: 'A Message from Rachel & Josh · Week 2', text: 'In this week’s video, Rachel and Josh share what Makia has meant in their own lives and how learning to focus and follow their attention has shaped what they have built and what they have let go of.', url: 'https://www.youtube.com/embed/Zstm7cLyEHE' },
  ...
  },
  {
    ...
    sub: 'You are unlimited. At your core, your essence is whole, resourceful, and infinitely creative.\n\nAlong the way, you’ve adopted beliefs, stories, and conditioning that are not in alignment with your true nature—many of which become held not only in the mind, but within the body as unprocessed emotion. When emotions remain unexpressed, they can create contraction, shaping how you relate to yourself and the world, often generating more suffering rather than connection.\n\nThis week is an invitation to bring compassionate awareness to the parts of yourself that feel limited, to gently release what no longer serves you, and to begin reconnecting with the wholeness that has always been within you.',
