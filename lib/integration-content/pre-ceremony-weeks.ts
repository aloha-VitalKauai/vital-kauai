...
export const WEEKS = [
  ...
  },
  {
    ...
    sub: 'You are unlimited. Your essence is whole, resourceful, and infinitely creative. Along the way, you’ve adopted stories, conditioning, and ways of being that are not in alignment with your true nature. Maybe they’ve caused you to doubt yourself, contract, or become a smaller version of yourself. This week is about bringing compassionate awareness to the limited parts of yourself and beginning to reconnect with your whole self.',
