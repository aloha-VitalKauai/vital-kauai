      ...
      <Section id="return" num="04" label="Integration" title="When They" titleEm="Return Home" rose={rose} border={border} sage={sage}>
        ...
        <div style={{ margin: "40px 0" }}>
          {[
            ...
            { time: "Weeks 2\u20138", title: "Active Integration", text: "Insights become changes, in habits, relationships, and perspective. Your person is meeting weekly with their Vital Kaua\u02bbi integration guide and continuing their journaling and integration work through this stretch. Your role here is to witness with open presence." },
