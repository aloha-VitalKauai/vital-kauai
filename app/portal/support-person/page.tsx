    ...
    <div style={{ minHeight: "100vh", background: cream, fontFamily: "'Jost', sans-serif", fontWeight: 300, lineHeight: 1.75, fontSize: 17, color: ink }}>
      ...
      <Section id="during" num="03" label="The Ceremony Days" title="While They Are" titleEm="in Ceremony" rose={rose} border={border} sage={sage}>
        ...
        <Callout color={rose} bg={roseLt} label="For You, While You Wait">
          The waiting is its own experience. You may feel restless, concerned, or simply aware of an open space. This is a meaningful time to hold them in your heart, to pray or set an intention for their wellbeing, or simply to go about your life knowing they are cared for. Should you need to reach us, call Rachel (808-855-5033) or Josh (623-330-8017), and we are happy to connect with you directly.
        </Callout>
      ...
      <Section id="return" num="04" label="Integration" title="When They" titleEm="Return Home" rose={rose} border={border} sage={sage}>
        ...
        <div style={{ margin: "40px 0" }}>
          {[
            { time: "First days home", title: "Landing", text: "They are stepping back into ordinary life after several days of held space on Kaua\u02bbi. Welcome them gently. Invite them to share if they want to share, and let silence be welcome too. Help them keep their load light: gentle in what they watch, listen to, and take on, and in the company they keep. This first week is for rest, nature, and simplicity." },
            { time: "Week 1\u20132", title: "Emergence", text: "These early days ask for doing less. Their nervous system is still tender and highly impressionable, so what serves them most is rest and sleep, time in nature, gentle bodywork, sunrise and sunset, and easy food with slow hydration. It helps to set aside intense exertion, screens, alcohol or other psychedelics, music with lyrics, and big plans or decisions, with sexual activity held until after the first week. Presence, appetite, and speech return gradually, and emotions may move unexpectedly, so let them share at their own pace." },
