...
const PHASES = [
  {
    ...
    prompts: [
      ...
      { q: "Where am I out of integrity? With whom or what am I not in right relationship?", hint: "Iboga sees everything. You may as well arrive having already looked." },
  ...
  },
  {
    ...
    isPhaseHeader: true,
    prompts: [
      { q: "What is present in my body right now? Where do I feel the most sensation, heaviness, lightness, or aliveness?", hint: "Stay in the body. No interpretation needed yet.", placeholder: "Describe sensations, not stories..." },
      ...
      { q: "Looking back at the intentions I set before ceremony \u2014 what was answered, exceeded, or transformed beyond what I could have imagined? What was perhaps not yet met or addressed?" },
  ...
  },
  {
    ...
    desc: "Integration is where ceremony becomes life. These prompts are designed to be worked with slowly, over weeks \u2014 returned to as new layers surface and as you encounter yourself in the ordinary world with new eyes. There is no rush. The medicine continues working long after the journey ends.",
    prompts: [
      ...
      { q: "What old patterns, reactions, or beliefs have I noticed returning \u2014 and how am I choosing to meet them now?", hint: "Return is not failure. It is part of the spiral. What matters is how you respond when the familiar appears." },
      ...
      { q: "What is still unresolved or in process? What has not yet found its form in words, understanding, or action?", hint: "Name the open edges. The most important material sometimes takes the longest to land." },
...
export default function JournalClient() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#FDFBF7", fontFamily: "'Jost', sans-serif", fontWeight: 300 }}>
      {/* Nav */}
      <nav style={{ position: "sticky", top: 0, zIndex: 50, background: "rgba(14,26,16,0.97)", backdropFilter: "blur(14px)", padding: "0 60px", height: 60, display: "flex", alignItems: "center", justifyContent: "space-between", borderBottom: "1px solid rgba(200,169,110,0.08)" }}>
        <a href="/portal" style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 17, fontWeight: 300, letterSpacing: "0.2em", color: "#F5F0E8", textTransform: "uppercase", textDecoration: "none" }}>Vital Kaua&#699;i</a>
        <span style={{ fontSize: 8.5, letterSpacing: "0.3em", textTransform: "uppercase", color: "#A8C5AC", border: "1px solid rgba(168,197,172,0.22)", padding: "5px 14px" }}>Iboga Journey Journal</span>
