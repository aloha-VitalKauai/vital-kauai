...
const WEEKS = [
  {
    ...
    subtitle: 'Let it.',
    intro: 'Lōkahi means unity — the integration of all that was shown into the whole of who you are. This week asks almost nothing of you except presence. Rest is not passive. Rest after ceremony is active integration. Your nervous system is processing at a depth you cannot fully feel or measure. Trust it.',
    safetyNote: {
      type: 'gold',
    ...
    actions: [
      { color: 'sage', text: 'Check in with your guide within 48 hours of returning home', note: 'Not a full session — a brief check-in to let them know you arrived safely, how you\'re doing, and what you most need right now. This is standard care after any deep experience.' },
      { color: 'green', text: 'Rest completely for the first 48 hours', note: 'No major decisions. No explaining yourself to people who weren\'t there. No attempting to translate what happened into language yet. Let it be unresolved.' },
    ...
    prompts: [
      { q: 'What did the medicine show me that I most need to remember?', hint: 'Not what you think it meant — what it actually showed you. The image, the moment, the knowing. Record it before it softens.' },
  ...
  },
  {
    ...
    intro: 'Mālama means to care for, to tend, to preserve. The noribogaine window — your brain\'s heightened state of plasticity — is at its most open right now. This is not metaphor. This is the most important behavioral window of your entire process. What you practice this week is being written more deeply than usual.',
    safetyNote: {
      type: 'gold',
    ...
    prompts: [
      { q: 'What one insight from ceremony most needs to become a daily practice — and what would that actually look like in my life?', hint: 'Not a resolution. A practice. Something you do with your body, not just something you understand in your mind. Be specific: what, when, how.' },
  ...
  },
  {
    ...
    carryForward: 'You\'ve been tending new practices. You\'ve begun to bring the insights into your days. This week something will shift — old patterns will begin to resurface. This is not regression. This is the real integration beginning.',
    intro: 'Haʻahaʻa means humility — the willingness to be exactly where you are without pretending to be further along. By week three, the acute aliveness of ceremony has softened. The ordinary world has returned. And with it, so have familiar patterns, old impulses, and the pull of who you used to be. This week asks you to meet all of that with humility rather than shame.',
    reentry: {
      strong: 'When the pattern hits — do this:',
      text: ' (1) Name it aloud or in writing: "This is the [fear / avoidance / contraction] pattern." (2) Feet flat on the floor. One hand on your heart. One slow breath — in for 5, hold for 2, out for 7. (3) Do not hide it. Tell your guide, your support person, or write it here. (4) Return to your practice — even for five minutes. The pattern cannot survive your sustained attention and your practice. That is not philosophy. That is neuroscience.',
    },
    ...
    actions: [
      { color: 'blue', text: 'Name one old pattern that has returned — write about it without judgment', note: 'Not to fix it. Not to condemn yourself for it. Just to see it clearly. Naming with precision is itself a form of integration. Your guide can see your weekly tracking and will reach out if they notice something that needs support.' },
  ...
  },
  {
    ...
    intro: 'Kuleana means responsibility — not burden, but sacred accountability. The medicine showed you something. You have seen it clearly. Week four is where the seeing becomes choosing. The noribogaine window is beginning to narrow. What you anchor into behavior now is what will carry forward.',
    safetyNote: {
      type: 'gold',
    ...
    actionLabel: 'This week — 3 things',
    actions: [
      { color: 'gold', text: 'Write your three non-negotiables for the next three months', note: 'Not a long list. Three things you are committing to — in your body, your relationships, your daily life — that reflect who you are becoming. Specific, liveable, honest.' },
      ...
      { color: 'sage', text: 'Audit one thing in your environment that actively works against your new self — and change it this week', note: 'Physical environment. Social environment. Digital environment. What in each is pulling you back toward who you were? Make one concrete change this week, not next week.' },
    ],
  ...
  },
  {
    ...
    actions: [
      ...
      { color: 'gold', text: 'Fourth integration call — bring the relational territory specifically', note: 'Name the conversations that happened or didn\'t happen. Name what the relational friction is bringing up. The relational field is often where the deepest integration work happens. Book via My Care Team.' },
    ],
    prompts: [
  ...
  },
  {
    ...
    carryForward: 'You have moved through the full arc — from the raw tenderness of emergence to the relational work of week five. This final week is not an ending. It is a transition from active integration into sustained living.',
    ...
    actions: [
      ...
      { color: 'blue', text: 'Final intensive integration call with your guide', note: 'This call closes the six-week arc and establishes your monthly rhythm. Bring your integration statement. Book via My Care Team.' },
    ...
    integrationStatement: [
      { q: 'What genuinely changed?', hint: 'Not aspirational — actual. How do you move through the world differently now? Name specific behaviors, responses, ways of being.' },
    ...
    prompts: [
      { q: 'Who am I now — compared to who I was when I arrived at ceremony?', hint: 'Be specific. Not aspirational — actual. What is genuinely different in how you move through the world, how you meet yourself, how you are in relationship?' },
      { q: 'Where have I drifted from what the medicine showed me — and what would it take to return?', hint: 'Honest accounting. Not self-criticism — honest inventory. The medicine gave you a clear picture. How close are you living to it right now?' },
    ],
