...
const WEEKS = [
  {
    ...
    prompts: [
      ...
      { q: 'What has become clear, or arrived as new knowing, in the last three days?', hint: 'Some knowing is instant. Some arrives slowly. Write what has landed — even if it is still forming. What is already different in you?' },
    ],
  ...
  },
  {
    ...
    prompts: [
      { q: 'What am I accountable to now — in ways the ceremony revealed?', hint: 'The medicine showed you something that lives in you now. What does that knowing require of you specifically? Name the accountability.' },
