    ...
    <>
      ...
      <style>{`
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        .wbtn{font-family:inherit;font-size:11px;font-weight:400;letter-spacing:.16em;text-transform:uppercase;padding:0 22px;height:52px;border:none;border-bottom:2px solid transparent;cursor:pointer;color:var(--ink-mid);background:transparent;white-space:nowrap;transition:all .2s}.wbtn:hover{color:var(--ink)}.wbtn.active{color:var(--forest);border-bottom-color:var(--gold);font-weight:500}.wbtn.done::after{content:' ✓';font-size:10px;color:var(--gold);margin-left:5px}@media (max-width:640px){.wbtn{font-size:10.5px;padding:0 15px;height:46px;letter-spacing:.14em}}
