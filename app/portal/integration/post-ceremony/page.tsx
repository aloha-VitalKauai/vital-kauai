...
const WEEKS = [
  {
    ...
    actions: [
      ...
      // 72-hour Outcome action hidden while outcomes are being reworked. Restore by uncommenting this block.
      // {
      //   color: 'gold',
  ...
  },
  {
    ...
    actions: [
      ...
      { color: 'gold', text: 'Establish one morning practice, and do it every day, tracking your days below', note: 'Coherent Heart Breath. Journaling. Movement. Prayer. One thing. Done every morning. The medicine opened the door. Repetition is how you walk through it. Your practice days matter.' },
  ...
  },
  {
    ...
    // 1-month outcomes dataset note hidden while outcomes are being reworked. Restore by uncommenting these two lines.
    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{ fontSize: 12.5, color: '#8B8070', marginBottom: 28, lineHeight: 1.7 }}>
          A weekly check-in to track your integration. Be honest, this is for you.
        </p>
