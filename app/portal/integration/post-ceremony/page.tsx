...
const WEEKS = [
  ...
  },
  {
    ...
    prompts: [
      ...
      { q: 'What did I already know before I arrived — that the ceremony simply confirmed?', hint: 'Sometimes the medicine doesn\'t reveal anything new. It makes what was already known impossible to ignore. What was confirmed? What could no longer be defended against?' },
    ],
