            ...
            <section className="w1-section" id="action-items">
              ...
              <div className="w1-actions">
                {actionsForWeek(i, w.actions).map((card, ai) => {
                  ...
                  // action, and the per-week "Connect with your PNE Practitioner"
                  ...
                  if (
                    ...
                    card.text === "Connect with your PNE Practitioner"
                  ) return null
                  ...
                  if (pneScrollTarget) {
                    ...
                    // Same destination the member would reach by hand — the
                    // practitioner's Calendly page — but routed through the
                    // Sessions engine so the booking is authorized and counted
                    // against the allowance the card above reads from.
                    body = (
                      <BookSessionButton
