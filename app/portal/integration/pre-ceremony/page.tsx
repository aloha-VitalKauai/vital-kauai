...
const WEEKS = [
  ...
  },
  {
    ...
    video: { label: 'A Message from Rachel & Josh · Week 4', text: 'This is the most important week. Rachel and Josh designed it this way to hold you through the deepest work of preparation. In this transmission they explain why the shadow work you do here changes what ceremony will ask of you, and how to go slow while staying grounded.' },
