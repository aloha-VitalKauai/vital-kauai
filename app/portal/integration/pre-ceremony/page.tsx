...
const WEEKS = [
  {
    ...
    box: { type: 'info', label: 'The most important safety variable', text: 'More than your labs. More than your diet. More than your supplement protocol — your honesty in this process is what most determines how the medicine meets you. Iboga surfaces what is true. The more clearly you can see yourself before you arrive, the more navigable the experience. This is not philosophy. It is how the medicine works.' },
  ...
  },
  {
    ...
    box: { type: 'info', label: 'The identity shift', text: 'You are no longer the person who was considering this. The moment you committed, something changed. This week\'s job is to feel that — not intellectually, but as a lived orientation. The portal, this video, and the prompts below all serve one thing: moving you from "I signed up for something" to "I am inside a process."' },
    actionLabel: 'Actions this week — 3 only',
    actionIntro: 'These actions are lighter than later weeks by design. Identity shifts happen in the noticing, not the forcing. This week your job is to begin seeing clearly — the changes will follow.',
    actions: [
      ...
      { color: 'amber', text: 'Begin noticing — not restricting — daily habits', note: 'Observe alcohol, sleep, screens, food, substances. No changes required yet. Just honest observation. What you notice this week becomes data for your body to begin working with.' },
  ...
  },
  {
    ...
    actions: [
      ...
      { color: 'green', text: 'Begin Coherent Heart Breath — 10 minutes, every morning, non-negotiable', note: 'This single practice does more for your ceremony readiness than almost anything else on this list. It is the minimum. Do it every day.' },
  ...
  },
  {
    ...
    video: { label: 'A Message from Rachel & Josh · Week 4', text: 'This is the hardest week. Rachel and Josh designed it that way — not to push you, but to protect you. In this transmission they explain why the shadow work you do here changes what ceremony will ask of you, and how to go slow without going nowhere.' },
    ...
    thread: 'What you name here, you are no longer carrying unconsciously. Iboga surfaces what we hold in the dark. You are turning on a light before you arrive. This is the most sophisticated preparation available. Next week you turn toward your people.',
  },
  {
    id: 4,
    code: 'ALOHA',
    ...
    reentry: { strong: 'Arriving at this week without having done Week 4\'s journaling?', text: ' Do one prompt from Week 4 — just one — before you move forward. The shadow work and the relational work are connected. Ten minutes of Week 4 journaling is your entry point.' },
