...
const SOPS: Sop[] = [
  ...
  },
  {
    ...
    title: 'Reference Itinerary · 8-day cohort',
    owner: 'Josh · Rachel · Sacred Hospitality Coordinator',
    updated: '2026-04-21',
    status: 'draft',
    summary: 'The canonical shape of a Vital Kauaʻi cohort week. Every cohort starts from this template and adapts to the group, the season, and the land. Variants for shorter (5-day) and longer (12-day) formats are noted at the bottom.',
    sections: [
      {
        heading: 'Day 1 · Arrival + threshold',
        items: [
          'Afternoon · guest arrivals staggered over a 3-hour window; airport pickup by coordinator with lei greeting.',
          '4:00pm · land blessing with kumu (before any members step onto the ceremonial ground).',
          '5:00pm · welcome pule + threshold crossing; members enter the land together.',
          '5:30pm · orientation walk: quarters, ceremony space, kitchen, emergency exits.',
          '6:30pm · first dinner, communal. Phones collected and placed at the altar.',
          '8:00pm · opening circle: names, intentions, agreements, silence protocol.',
          '10:00pm · lights out. Coordinator holds first night.',
        ],
      },
      {
        heading: 'Day 2 · Attunement',
        items: [
          '6:30am · sunrise pule + gentle movement on the lanai.',
          '7:30am · communal breakfast, first 10 minutes silent.',
          '9:00am · medical intake confirmation 1:1 with Jon Allen PA-C (vitals, med review, any last flags).',
          '10:30am · land + cultural orientation with kumu (protocols, kapu, relationship to place).',
          '12:00pm · lunch + midday rest (no programming 12–2pm).',
          '2:30pm · breathwork session with Rachel.',
          '4:30pm · somatic integration circle.',
          '6:30pm · dinner.',
          '8:00pm · evening story circle: lineage, the medicine, what is being asked of us.',
        ],
      },
      {
        heading: 'Day 3 · Preparation',
        items: [
          '6:30am · pule + movement.',
          '7:30am · breakfast — pre-ceremony diet deepens (no caffeine, lighter foods, lower sodium).',
          '9:00am · final clinical review + cardiac monitoring equipment check.',
          '10:30am · 1:1 with integration guide: intention refinement, fear inventory, consent review.',
          '12:00pm · lunch + rest.',
          '2:30pm · ceremonial prep — members dress the altar together with offerings they brought.',
          '4:30pm · quiet time, journaling, personal walk on the land.',
          '6:00pm · light dinner.',
          '8:30pm · early sleep; medicine day tomorrow.',
        ],
      },
      {
        heading: 'Day 4 · Medicine day',
        items: [
          '7:00am · quiet rise, broth and water only.',
          '9:00am · morning stillness — meditation, no phones, no conversation beyond essentials.',
          '11:00am · final vitals + ECG check by medical lead.',
          '12:00pm · light ceremonial meal (per protocol).',
          '3:00pm · rest window; members are invited to set their final intention.',
          '6:00pm · ceremony space opens; pule, chant, threshold.',
          '~7:00pm · first dose administered per Jon Allen protocol; continuous monitoring begins.',
          'Through the night · ceremony held. Medical lead on vitals, holders on container, coordinator on the room.',
          'Dawn · closing of the acute window, medicine walk down with holders, vitals stable.',
        ],
      },
      {
        heading: 'Day 5 · Release + rest',
        items: [
          'Sleep protected until members naturally wake; no alarms, no schedule.',
          'Coordinator prepares a warming broth meal for each member as they rise.',
          'Gentle presence only — no group programming, no structured circle.',
          '1:1 check-ins with guide available on request.',
          'Walk on the land optional; nature immersion without agenda.',
          'Early, simple dinner. Quiet night.',
        ],
      },
      {
        heading: 'Day 6 · Integration begins',
        items: [
          '7:00am · pule + movement (optional).',
          '8:00am · breakfast, communal, quieter than usual.',
          '10:00am · first integration circle — what came through, what is still moving.',
          '12:00pm · lunch + rest.',
          '2:30pm · creative expression: drawing, voice, movement — non-verbal integration.',
          '4:30pm · 1:1 with integration guide (scheduled in staggered windows).',
          '6:30pm · dinner.',
          '8:00pm · story circle: what members are carrying home.',
        ],
      },
      {
        heading: 'Day 7 · Weaving',
        items: [
          '7:00am · pule + movement.',
          '8:00am · breakfast.',
          '9:30am · second integration circle — structured around the 6-week / 6-month arc ahead.',
          '11:00am · practical integration workshop: daily practice, patterns to watch, what to tell loved ones.',
          '12:30pm · lunch.',
          '2:30pm · 1:1 with guide — follow-up schedule confirmed (PHQ-9/GAD-7 check-ins at 1wk, 1mo, 3mo, 6mo).',
          '4:30pm · free time on the land; many members choose the ocean.',
          '6:30pm · community dinner — first course prepared by members together.',
          '8:00pm · gratitudes circle.',
        ],
      },
      {
        heading: 'Day 8 · Closing + departure',
        items: [
          '7:00am · pule + closing movement.',
          '8:00am · final breakfast.',
          '9:30am · closing circle: what each member carries, what stays on the land.',
          '10:30am · lei of departure + personalized blessing from kumu.',
          '11:00am · phones returned at the threshold.',
          '11:15am · integration packet handed to each member in person (follow-up schedule, guide contact, emergency lines).',
          '12:00pm · coordinator-led departures begin; airport runs staggered through the afternoon.',
          'Within 48 hours · coordinator writes a one-paragraph note per member for the integration team.',
        ],
      },
      {
        heading: 'Cross-week rhythm',
        items: [
          'Meals are communal; first 10 minutes of breakfast always silent.',
          'Midday rest 12–2pm is protected every day, including medicine day.',
          'Phones live at the altar from Day 1 threshold to Day 8 threshold.',
          'Night oversight by coordinator + rotating night watch; explicit verbal handoffs only.',
          'Staff huddle every morning at 7:45am (15 min) — flag anyone who needs extra care today.',
          'Daily debrief every evening at 9:30pm after members are settled.',
        ],
      },
      {
        heading: 'Variants',
        items: [
          '5-day intensive · compresses Days 2–3 into one, holds single ceremony night, skips Day 7 weaving. Used for returning members or smaller containers.',
          '12-day deep arc · adds a second ceremony on Day 7, extends integration by three full days. Reserved for invitation-only cohorts.',
          'Any variant must be approved by Josh or Rachel and coordinated with medical lead before a date is offered.',
        ],
      },
    ],
  },
