    ...
    <div style={{ minHeight: "100vh", background: "#FAFAF8" }}>
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          ...
          <a href="/ops/pending" style={{ fontSize: 11, letterSpacing: "0.08em", textTransform: "uppercase", background: "#0E0C0A", border: "0.5px solid rgba(0,0,0,0.35)", borderRadius: 6, padding: "5px 12px", cursor: "pointer", fontFamily: "var(--font-body, sans-serif)", color: "#F0EBE0", textDecoration: "none" }}>Ops Dashboard</a>
