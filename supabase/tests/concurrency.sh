...
sleep 1
s2 "select 'S2_BLOCKED_MARKER';"
sleep 1
grep -q S2_BLOCKED_MARKER "$D/o2" && B21=no || B21=yes   # marker absent => S2 is blocked
s1 "commit;"
sleep 2
s2 "commit;"
sleep 1
psql -q -d "$DB" -c "insert into conc_result values ('r21_s2_blocked','$B21')"
...
sleep 1
s2 "select 'S2_LINK_MARKER';"
sleep 1
grep -q S2_LINK_MARKER "$D/o2" && B37=no || B37=yes
s1 "commit;"
sleep 2
s2 "commit;"
sleep 1
psql -q -d "$DB" -c "insert into conc_result values ('r37_s2_blocked','$B37')"
...
sleep 1
s2 "select 'S2_REFUND_MARKER';"
sleep 1
grep -q S2_REFUND_MARKER "$D/o2" && B50=no || B50=yes
s1 "commit;"
sleep 2
s2 "commit;"
sleep 2
...
sleep 1
s2 "select 'S2_SESSION_MARKER';"
sleep 1
grep -q S2_SESSION_MARKER "$D/o2" && B35=no || B35=yes
s1 "commit;"
sleep 2
s2 "commit;"
sleep 2
psql -q -d "$DB" -c "insert into conc_result values ('r35_s2_blocked','$B35')"
