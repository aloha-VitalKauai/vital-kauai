    ...
    <main ref={pageRef} className={styles.page}>
          ...
          <div className={`${styles.whyIbogaGrid} ${styles.reveal}`}>
            ...
            <div>
              ...
              <p className={styles.storyBody}>
                ...
                exists to serve the medicine: the land, the team, the preparation, and every
                branch that grows from the root.
              </p>
      ...
      <section id="offerings" className={styles.offerings}>
        ...
        <div className={`${styles.offeringTags} ${styles.reveal}`}>
          {["Somatics", "Nervous System Safety", "Cleansing", "Yoga", "Breathwork", "Sound Healing", "Bodywork", "Movement", "Energetics", "Nature Immersion", "Integration", "Ceremony"].map(
            (tag, index) => (
