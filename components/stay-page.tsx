...
<div style="background:var(--forest);padding:64px 60px;text-align:center;border-top:1px solid rgba(200,169,110,0.12);border-bottom:1px solid rgba(200,169,110,0.08);">
  ...
  <a href="https://calendly.com/aloha-vitalkauai" target="_blank" style="display:inline-block;font-size:10px;font-weight:400;letter-spacing:0.3em;text-transform:uppercase;color:var(--forest);background:var(--gold);padding:18px 44px;text-decoration:none;transition:background 0.3s;">Join Our Next Group Ceremony</a>
...
<section style="background:var(--forest-dark);padding:80px 60px;text-align:center;">
  <div style="max-width:860px;margin:0 auto;">
    ...
    <a href="https://calendly.com/aloha-vitalkauai" target="_blank" style="display:inline-block;font-size:10px;font-weight:400;letter-spacing:0.3em;text-transform:uppercase;color:var(--forest);background:var(--gold);padding:18px 44px;text-decoration:none;">Join Our Next Group Ceremony</a>
  </div>
</section>
