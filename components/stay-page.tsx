...
export function StayPage() {
  useEffect(() => {
    ...
    fetchPublicCohorts(supabase).then((rawCohorts) => {
      ...
      if (heroEl) {
        const next = nextIdx >= 0 ? cohorts[nextIdx] : null;
        heroEl.textContent = next
          ? `Next Group Ceremony · ${formatCohortRange(next.start_at, next.end_at)} · Hanalei, Kauaʻi`
          : "Hanalei, Kauaʻi";
      }
...
<section id="included">
  ...
  <div class="included-grid">
    <div class="included-card reveal">
      ...
      <p class="included-body">Your ceremony stay is intentionally designed: yoga, breathwork, massage, energy healing, sound healing, Iboga ceremony, and integration work, held in our dedicated space or in nature.</p>
    </div>
...
<section style="background:var(--forest-dark);padding:80px 60px;text-align:center;">
  <div style="max-width:860px;margin:0 auto;">
    ...
    <p class="reveal" style="font-size:15px;color:rgba(245,240,232,0.6);line-height:1.95;margin-bottom:48px;max-width:600px;margin-left:auto;margin-right:auto;">Each ceremony is a small, held gathering of up to six members. Book a discovery call to learn about the next available date.</p>
    ...
    <div class="faq-list reveal">
      ...
      <details class="faq-item">
        ...
        <div class="faq-answer">
          <p>Our group ceremony moves through arrival, preparation, ceremony, integration, and closing. We discuss your specific journey and any additional support you may need on your discovery call.</p>
        </div>
      </details>
